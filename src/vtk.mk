...
define $(PKG)_BUILD
    ...
    cd '$(BUILD_DIR)' && '$(TARGET)-cmake' '$(SOURCE_DIR)' \
        ...
        $(PKG_CONFIGURE_OPTS)
	echo 'target_link_libraries(VTK::RenderingCore INTERFACE $(PREFIX)/$(TARGET)/lib/libbrotlidec.a $(PREFIX)/$(TARGET)/lib/libbrotlienc.a $(PREFIX)/$(TARGET)/lib/libbz2.a)' >> $(BUILD_DIR)/lib/cmake/$(call SHORT_PKG_VERSION,$(PKG))/vtk-config.cmake
